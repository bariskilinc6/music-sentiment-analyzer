...
# ✅ CSV'den ilk 200 yorumu oku
df = pd.read_csv("apple_music_yorumlari.csv")
yorumlar = df["content"].dropna().iloc[:200].tolist()  # ⬅️ sadece 200 yorum
...
analiz_df.to_csv("applemusic_konu_analizi.csv", index=False)
print("✅ Apple Music konu analizi tamamlandı.")
