...
# ✅ CSV'den ilk 200 yorum okunuyor (YouTube Music)
df = pd.read_csv("youtube_music_yorumlari.csv")
...
# ✅ Sonuçları CSV'ye kaydet (YouTube Music için)
analiz_df = pd.DataFrame(analizler)
analiz_df.to_csv("ytmusic_konu_analizi.csv", index=False)
print("✅ YouTube Music konu analizi tamamlandı.")
